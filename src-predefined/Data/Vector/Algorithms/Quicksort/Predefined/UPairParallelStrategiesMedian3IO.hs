...
sortUPairParallelStrategiesMedian3IO :: U.MVector RealWorld (Int32, Int32) -> IO ()
sortUPairParallelStrategiesMedian3IO = Quick.sort ParStrategies (Median3 @(Int32, Int32))
