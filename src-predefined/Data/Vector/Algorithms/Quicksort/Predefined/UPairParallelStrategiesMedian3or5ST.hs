...
sortUPairParallelStrategiesMedian3or5ST :: U.MVector s (Int32, Int32) -> ST s ()
sortUPairParallelStrategiesMedian3or5ST = Quick.sort ParStrategies (Median3or5 @(Int32, Int32))
